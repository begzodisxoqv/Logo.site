...
@section('main')
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <ul>
                <li><a href="{{ route('team.index') }}">Все данные</a></li>
            </ul>
        </div>
                        ...
                        <form action="{{ route('team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    <label>title </label>
                                    <input class="form-control @error('title') is-invalid @enderror" value="{{ $team->title }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('text') is-invalid @enderror" value="{{ $team->text }}"
