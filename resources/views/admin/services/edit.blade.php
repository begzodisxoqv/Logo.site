                        ...
                        <form action="{{ route('services.update', $services->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    <label>title </label>
                                    <input class="form-control @error('title_1') is-invalid @enderror" value="{{ $services->title_1 }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('text') is-invalid @enderror" value="{{ $services->text }}"
