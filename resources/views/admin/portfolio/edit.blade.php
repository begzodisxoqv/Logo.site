                        ...
                        <form action="{{ route('portfolio.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    <label>title </label>
                                    <input class="form-control @error('title') is-invalid @enderror" value="{{ $portfolio->title }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('text') is-invalid @enderror" value="{{ $portfolio->text }}"
