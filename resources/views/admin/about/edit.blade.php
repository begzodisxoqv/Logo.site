                        ...
                        <form action="{{ route('abouts.update',   $abouts->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input class="form-control @error('title') is-invalid @enderror" value="{{ $abouts->title }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label>text</label>
                                    <input class="form-control @error('	text') is-invalid @enderror" value="{{ $abouts->text }}"
                                ...
                                <div class="col-12 form-group mb-3">
                                    <img src="{{ asset( 'storage/' . $abouts->image) }}" class="img-fluid"
