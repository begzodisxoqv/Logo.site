                                        ...
                                        @foreach($abouts as $abt)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <a data-toggle="modal" data-target="#deletesModal{{$abt->id}}" class="text-danger mr-2" href="{{ route('abouts.destroy', $abt->id) }}"><i class="nav-icon far fa-times-circle font-weight-bold"></i></a>
